...
This is a custom fork of the Crazyflie 2.x firmware with support for onboard neural network control policies. Follow instructions out of `examples/app_race_policy/README.md` to use the new features. 
